              ...
              <div className="max-w-[1240px] mx-auto h-full">
                {show ? (
                  ...
                  <div className="my-3 text-center">
                    <div className={`${theme === 'light' ? 'text-[#919191]' : 'text-[#efefef]'} font-semibold text-xs uppercase -mb-2`}>
                      category
                    </div>
                    <h1 className={`${theme === 'light' ? 'text-[#111111]' : 'text-[#fff]'} text-[41px] font-black`}>
                      {categoryData.name}
                    </h1>
                  </div>
                )}
